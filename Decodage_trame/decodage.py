...
try:
	while True:
		...
		if field_1 == "0x800":
			trames.append(decodage_udp(date2, bench_3, bench_5, framesize, trame))
		elif field_1 == "0x806":
			trames.append(decodage_arp(date2, bench_3, bench_5, framesize, trame)) 
		else:
			break
except struct.error:
    None
